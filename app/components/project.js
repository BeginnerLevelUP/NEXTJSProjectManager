...
const renderNav = () => {
  if (isActiveHome || isActiveAddProjects || isActiveAddMember || isActiveProject) {
    return (
      <>
        <div>
          <div
